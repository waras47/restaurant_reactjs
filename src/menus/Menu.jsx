...
const Menu = () => {
  ...
  return (
    <div>
      ...
      <section className="section menu" aria-label="menu-label" id="menu" style={{ marginTop: '10px' }}>
        <div className="container">

          <h2 className="headline-1 section-title text-center">Vlees & Groenten Keuzen Maaltijden</h2>
